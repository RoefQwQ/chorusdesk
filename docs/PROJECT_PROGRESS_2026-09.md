...
- **已否决（不要重新提出）**：AUDIT P2-16——不采用 PR-first 工作流（2026-09-12 用户决定）。
- **未完成待办**：AUDIT P2-17（b）**`AGENTS.md` 减负**——独立待办，顺序约束已满足，见
  `AUDIT_2026-09-12.md` §P2-17；（a）待办迁 Issues 未决定。
  > 此处曾把整条 P2-17 误记为「已否决」，勘误见 P8 交接基线同名条目。
