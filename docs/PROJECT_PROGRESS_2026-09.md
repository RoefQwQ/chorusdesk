...
- **已否决（不要重新提出）**：AUDIT 的 P2-16/17——不采用 PR-first 工作流
  （2026-09-12 用户决定），待办继续由文档承载；因此 `AGENTS.md` 减负也不做
  （其前提是「待办有别的去处」）。见 `AUDIT_2026-09-12.md` §5 的 P2 表。
...
- **2026-09-12 审计批：[AUDIT_2026-09-12.md](AUDIT_2026-09-12.md)**——**该批已全部结清，文件已降级为纯历史**
  （不再承接新待办）：P0/P1 全批 + P2 的 13–15、18–20 已实现；**P2-16/17 经用户决定不做**
  （2026-09-12：不采用 PR-first；待办继续由文档承载，因此 `AGENTS.md` 减负也不做，
  其前提「待办有别的去处」不成立）。**不要重新提出这两项。**
